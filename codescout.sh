...
./codescout.py -m "L'ambition de faire:le bien est la:seule qui compte" -c $code -i 2 -b 3
./codescout.py -m "L'optimisme est:une forme de courage:qui donne confiance:aux autres" -c $code -i 2 -b 3
./codescout.py -m "La vie est trop:courte pour:qu'on se dispute" -c $code -i 2 -b 3
./codescout.py -m "La bonne humeur:est aussi contagieuse:que la rougeole" -c $code -i 2 -b 3
./codescout.py -m "Les connaissances:qu'on a cherchees:restent" -c $code -i 2 -b 3
./codescout.py -m "Y'a du boulot:pour les castors" -c $code -i 2 -b 3
./codescout.py -m "Contentez vous de:ce que vous avez:et faites-en:le meilleur:usage possible" -c $code -i 2 -b 3
./codescout.py -m "Le bonheur ne vient:pas a ceux qui:l'attendent assis" -c $code -i 2 -b 3
./codescout.py -m "Sois pret:Be Prepared" -c $code -i 2 -b 3
./codescout.py -m "Le scout merite:et fait confiance" -c $code -i 2 -b 3
./codescout.py -m "Le scout combat:pour la justice" -c $code -i 2 -b 3
./codescout.py -m "Le scout:partage avec tous" -c $code -i 2 -b 3
./codescout.py -m "Le scout est:frere de tous" -c $code -i 2 -b 3
